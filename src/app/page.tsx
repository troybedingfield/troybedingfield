      ...
      <div className="saas-work">
        <div className="inner-container">
          ...
          <motion.div initial={{ opacity: 0 }}
            ...
            <Image src="/public/troy-homepage-montage-01.png" alt="saas-examples" width="1107" height="532" sizes="((max-width: 768px) 100vw, (max-height: auto) 100vh )" style={{ objectFit: "contain" }} />
          </motion.div>
        </div>
      </div>
